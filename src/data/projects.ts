...
export const projects: Project[] = [
  {
    ...
    coverImage: '/images/project-xiuxian.png',
  ...
  },
  {
    ...
    coverImage: '/images/project-sgs.png',
  ...
  },
  {
    ...
    subtitle: 'AstrBot 长期记忆 · 五层架构 · GraphRAG 双螺旋检索',
    description:
    ...
    coverImage: '/images/project-memory.png',
    techStack: ['Python', 'Vue3', 'FastAPI', 'Milvus', 'GraphRAG', 'AI Agent', 'MCP'],
    githubUrl: 'https://github.com/lxfight/astrbot_plugin_mnemosyne',
    year: 2024,
    featured: true,
  },
  {
    ...
    coverImage: '/images/project-github.png',
